...
// Testing the RESTful web service JWT Authentication functionality

@RunWith(SpringRunner.class)
@SpringBootTest
@AutoConfigureMockMvc
public class UserRestTest {
	// MockMvc object tests the layer where Spring handles HTTP requests
	// We do this without starting the server
	@Autowired
